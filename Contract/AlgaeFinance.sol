...
contract Algae_Finance{
    uint public totalInvested;
    uint public totalWithdrawn;
    uint public totalRefferalPayout;
    uint public totalInvestors;
    uint private minDepositSize = 50000000; //50 TRX Min Deposit Size
    uint private maxDepositSize = 100000000000; //100,000 TRX Max Deposit Size Per Invest
